...
//Error BI1026: bgen: `enums`: Enums attributed with[NativeAttribute] must have an 
//underlying type of `long` or `ulong` in parameter `reason' from MapboxEnums
namespace Mapbox
{
    [Native]
    ...
    //TODO Fix PInvokes
    //This method aren't part of symbol of the framework using the command nm on the shell
