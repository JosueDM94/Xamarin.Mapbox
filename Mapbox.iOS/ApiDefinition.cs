...
//Error BI1017: bgen: Do not know how to make a signature for CoreLocation.CLLocationCoordinate2D* in method `get_Coordinates'
namespace Mapbox
{
    [Static]
    ...
    partial interface Constants
    {
        ...
        //Error BI1014: bgen: Unsupported type for Fields: byte[] for 'Mapbox.Constants MapboxVersionString'.
    ...
    //Error CS0246: The type or namespace name 'MGLAnnotation' could not be found (are you missing a using directive or an assembly reference?)
    ...
    interface MGLCalloutView
    {
        ...
        //Error CS0500: 'MGLCalloutView.Delegate.get' cannot declare a body because it is marked abstract
        [Wrap("WeakDelegate")]
        [NullAllowed]
    ...
    partial interface Constants
    {
        // extern const NSUInteger MGLClusterIdentifierInvalid __attribute__((visibility("default")));
        [Field("MGLClusterIdentifierInvalid", "__Internal")]
        nuint MGLClusterIdentifierInvalid { get; }
    }

    //Error CS0246: The type or namespace name 'MGLFeature' could not be found (are you missing a using directive or an assembly reference?) (CS0246)
    ...
    partial interface Constants
    {
        //Error BI1014: bgen: Unsupported type for Fields: MGLCoordinateSpan for 'Mapbox.Constants MGLCoordinateSpanZero'.
        ...
        IntPtr MGLCoordinateSpanZero { get; }
    }

    //Error CS0246: The type or namespace name 'MGLOverlay' could not be found(are you missing a using directive or an assembly reference?)
    // @protocol MGLOverlay <MGLAnnotation>
    [Protocol, Model]
    [BaseType(typeof(NSObject))]
    interface MGLOverlay : MGLAnnotation
    {
        //Error CS0102: The type 'MGLOverlayWrapper' already contains a definition for 'Coordinate'
        // @required @property (readonly, nonatomic) CLLocationCoordinate2D coordinate;
        //[Abstract]
        //[Export("coordinate")]
        //CLLocationCoordinate2D Coordinate { get; }
    ...
    interface IMGLOverlay { }

    //[Static]
    //[Verify(ConstantsInterfaceAssociation)]
    partial interface Constants
    {
        // extern const MGLExceptionName _Nonnull MGLAbstractClassException __attribute__((visibility("default")));
        [Field("MGLAbstractClassException", "__Internal")]
        NSString MGLAbstractClassException { get; }
    ...
    //Error CS0246: The type or namespace name 'MGLFeature' could not be found (are you missing a using directive or an assembly reference?)
    ...
    interface IMGLFeature { }

    // @interface MGLEmptyFeature : MGLShape <MGLFeature>
    [BaseType(typeof(MGLShape))]
    interface MGLEmptyFeature : IMGLFeature
    {
    }
    ...
    interface MGLPointFeatureCluster : IMGLCluster
    {
    }
    ...
    interface MGLMapCamera : INSSecureCoding, INSCopying
    {
        ...
        MGLMapCamera CameraLookingAtCenterCoordinate(CLLocationCoordinate2D centerCoordinate, double altitude, nfloat pitch, double heading);
    ...
    partial interface Constants
    {
        ...
        double MGLMapViewDecelerationRateNormal { get; }
        ...
        double MGLMapViewDecelerationRateFast { get; }
        ...
        double MGLMapViewDecelerationRateImmediate { get; }
    }
    ...
    partial interface Constants
    {
        ...
        nint MGLMapViewPreferredFramesPerSecondDefault { get; }
        ...
        nint MGLMapViewPreferredFramesPerSecondLowPower { get; }
        ...
        nint MGLMapViewPreferredFramesPerSecondMaximum { get; }

        // extern const MGLExceptionName _Nonnull MGLMissingLocationServicesUsageDescriptionException __attribute__((visibility("default")));
        [Field("MGLMissingLocationServicesUsageDescriptionException", "__Internal")]
        NSString MGLMissingLocationServicesUsageDescriptionException { get; }

        // extern const MGLExceptionName _Nonnull MGLUserLocationAnnotationTypeException __attribute__((visibility("default")));
        [Field("MGLUserLocationAnnotationTypeException", "__Internal")]
        NSString MGLUserLocationAnnotationTypeException { get; }

        // extern const MGLExceptionName _Nonnull MGLResourceNotFoundException __attribute__((visibility("default")));
        [Field("MGLResourceNotFoundException", "__Internal")]
        NSString MGLResourceNotFoundException { get; }
    }
    ...
    interface MGLMapView
    {
        ...
        // @property (nonatomic) id<MGLLocationManager> _Null_unspecified locationManager;
        [Export("locationManager", ArgumentSemantic.Assign)]
        ...
        //Error BI1017: bgen: Do not know how to make a signature for CoreLocation.CLLocationCoordinate2D
        //in parameter `coordinates' from Mapbox.MGLMapView.SetVisibleCoordinates
    ...
    //Error CS0708: 'MGLMapView_IBAdditions.Attributes': cannot declare instance members in a static class
    ...
    interface MGLMapViewDelegate
    {
        ...
        bool ShouldChangeFromCamera(MGLMapView mapView, MGLMapCamera oldCamera, MGLMapCamera newCamera);
        ...
        bool ShouldChangeFromCamera(MGLMapView mapView, MGLMapCamera oldCamera, MGLMapCamera newCamera, MGLCameraChangeReason reason);
        ...
        void RegionWillChangeWithReason(MGLMapView mapView, MGLCameraChangeReason reason, bool animated);
        ...
        void RegionIsChangingWithReason(MGLMapView mapView, MGLCameraChangeReason reason);
        ...
        void RegionDidChangeWithReason(MGLMapView mapView, MGLCameraChangeReason reason, bool animated);
        ...
        void DidBecomeIdle(MGLMapView mapView);
        ...
        void DidUpdateUserLocation(MGLMapView mapView, [NullAllowed] MGLUserLocation userLocation);
        ...
        CGPoint UserLocationAnchorPoint(MGLMapView mapView);
        ...
        bool ShapeAnnotationIsEnabled(MGLMapView mapView, MGLShape annotation);
        ...
        void CalloutAccessoryControlTapped(MGLMapView mapView, MGLAnnotation annotation, UIControl control);
    ...
    interface IMGLOfflineRegion { }

    //[Static]
    //[Verify(ConstantsInterfaceAssociation)]
    partial interface Constants
    {
        // extern const MGLExceptionName _Nonnull MGLInvalidOfflinePackException __attribute__((visibility("default")));
        [Field("MGLInvalidOfflinePackException", "__Internal")]
        NSString MGLInvalidOfflinePackException { get; }
    }
    ...
    partial interface Constants
    {
        ...
        // extern const MGLExceptionName _Nonnull MGLUnsupportedRegionTypeException __attribute__((visibility("default")));
        [Field("MGLUnsupportedRegionTypeException", "__Internal")]
        NSString MGLUnsupportedRegionTypeException { get; }
    }
    ...
    interface MGLOfflineStorage
    {
        ...
        // -(void)preloadData:(NSData * _Nonnull)data forURL:(NSURL * _Nonnull)url modificationDate:(NSDate * _Nullable)modified expirationDate:(NSDate * _Nullable)expires eTag:(NSString * _Nullable)eTag mustRevalidate:(BOOL)mustRevalidate;
        ...
        // -(void)putResourceWithUrl:(NSURL * _Nonnull)url data:(NSData * _Nonnull)data modified:(NSDate * _Nullable)modified expires:(NSDate * _Nullable)expires etag:(NSString * _Nullable)etag mustRevalidate:(BOOL)mustRevalidate __attribute__((deprecated("Use -preloadData:forURL:modificationDate:expirationDate:eTag:mustRevalidate:.")));
    ...
    partial interface Constants
    {
        // extern const MGLExceptionName _Nonnull MGLInvalidStyleLayerException __attribute__((visibility("default")));
        [Field("MGLInvalidStyleLayerException", "__Internal")]
        NSString MGLInvalidStyleLayerException { get; }
    }
    ...
    partial interface Constants
    {
        // extern const MGLExceptionName _Nonnull MGLInvalidStyleURLException __attribute__((visibility("default")));
        [Field("MGLInvalidStyleURLException", "__Internal")]
        NSString MGLInvalidStyleURLException { get; }

        // extern const MGLExceptionName _Nonnull MGLRedundantLayerException __attribute__((visibility("default")));
        [Field("MGLRedundantLayerException", "__Internal")]
        NSString MGLRedundantLayerException { get; }

        // extern const MGLExceptionName _Nonnull MGLRedundantLayerIdentifierException __attribute__((visibility("default")));
        [Field("MGLRedundantLayerIdentifierException", "__Internal")]
        NSString MGLRedundantLayerIdentifierException { get; }

        // extern const MGLExceptionName _Nonnull MGLRedundantSourceException __attribute__((visibility("default")));
        [Field("MGLRedundantSourceException", "__Internal")]
        NSString MGLRedundantSourceException { get; }

        // extern const MGLExceptionName _Nonnull MGLRedundantSourceIdentifierException __attribute__((visibility("default")));
        [Field("MGLRedundantSourceIdentifierException", "__Internal")]
        NSString MGLRedundantSourceIdentifierException { get; }
    }
    ...
    interface MGLFillExtrusionStyleLayer
    {
        ...
        // @property (nonatomic) NSExpression * _Null_unspecified fillExtrusionHasVerticalGradient;
        [Export("fillExtrusionHasVerticalGradient", ArgumentSemantic.Assign)]
    ...
    interface NSValue_MGLFillExtrusionStyleLayerAdditions
    {
        ...
        //Error CS0708: 'MGLFillExtrusionStyleLayerAdditions.MGLFillExtrusionTranslationAnchorValue': cannot declare instance members in a static class
    ...
    interface NSValue_MGLFillStyleLayerAdditions
    {
        ...
        //Error CS0708: 'MGLFillStyleLayerAdditions.MGLFillTranslationAnchorValue': cannot declare instance members in a static class
    ...
    interface MGLLineStyleLayer
    {
        ...
        // @property (nonatomic) NSExpression * _Null_unspecified lineGradient;
        [Export("lineGradient", ArgumentSemantic.Assign)]
    ...
    //Error CS0708: 'NSValue_MGLLineStyleLayerAdditions.Attributes': cannot declare instance members in a static class
    ...
    interface MGLSymbolStyleLayer
    {
        ...
        // @property (nonatomic) NSExpression * _Null_unspecified symbolZOrder;
        [Export("symbolZOrder", ArgumentSemantic.Assign)]
    ...
    //Error CS0708: 'NSValue_MGLSymbolStyleLayerAdditions.Attributes': cannot declare instance members in a static class
    ...
    interface NSValue_MGLSymbolStyleLayerAdditions
    {
        ...
        MGLIconAnchor MGLIconAnchorValue { get; }
        ...
        MGLIconPitchAlignment MGLIconPitchAlignmentValue { get; }
        ...
        MGLSymbolZOrder MGLSymbolZOrderValue { get; }
    ...
    interface MGLRasterStyleLayer
    {
        ...
        // @property (nonatomic) NSExpression * _Null_unspecified rasterResamplingMode;
        [Export("rasterResamplingMode", ArgumentSemantic.Assign)]
    ...
    interface NSValue_MGLRasterStyleLayerAdditions
    {
        ...
        //Error CS0708: 'NSValue_MGLRasterStyleLayerAdditions.MGLRasterResamplingModeValue': cannot declare instance members in a static class
    ...
    //Error CS0708: 'NSValue_MGLCircleStyleLayerAdditions.Attributes': cannot declare instance members in a static class
    ...
    interface NSValue_MGLCircleStyleLayerAdditions
    {
        ...
        MGLCirclePitchAlignment MGLCirclePitchAlignmentValue { get; }
    ...
    interface NSValue_MGLHillshadeStyleLayerAdditions
    {
        ...
        //Error CS0708: 'MGLHillshadeStyleLayerAdditions.MGLHillshadeIlluminationAnchorValue': cannot declare instance members in a static class
        ...
        MGLHillshadeIlluminationAnchor MGLHillshadeIlluminationAnchorValue { get; }
    }
    ...
    //Error CS0311: The type 'Mapbox.MGLSource' cannot be used as type parameter 'TKey' in the generic type or method
    //'NSSet<TKey>'. There is no implicit reference conversion from 'Mapbox.MGLSource' to 'ObjCRuntime.INativeObject'.
    ...
    partial interface Constants
    {
        ...
        NSString MGLTileSourceOptionCoordinateBounds { get; }
    ...
    partial interface Constants
    {
        ...
        NSString MGLShapeSourceOptionMinimumZoomLevel { get; }
        ...
        NSString MGLShapeSourceOptionLineDistanceMetrics { get; }
    }
    ...
    interface MGLShapeSource
    {
        ...
        MGLFeature[] LeavesOfCluster(MGLPointFeatureCluster cluster, nuint offset, nuint limit);

        // -(NSArray<id<MGLFeature>> * _Nonnull)childrenOfCluster:(MGLPointFeatureCluster * _Nonnull)cluster;
        [Export("childrenOfCluster:")]
        MGLFeature[] ChildrenOfCluster(MGLPointFeatureCluster cluster);
    ...
    partial interface Constants
    {
        ...
        NSString MGLShapeSourceOptionWrapsCoordinates { get; }
        ...
        NSString MGLShapeSourceOptionClipsCoordinates { get; }

        // extern const MGLExceptionName _Nonnull MGLInvalidDatasourceException __attribute__((visibility("default")));
        [Field("MGLInvalidDatasourceException", "__Internal")]
        NSString MGLInvalidDatasourceException { get; }
    }
    ...
    interface MGLComputedShapeSourceDataSource
    {
        ...
        MGLFeature[] FeaturesInTileAtX(nuint x, nuint y, nuint zoomLevel);
        ...
        MGLFeature[] FeaturesInCoordinateBounds(MGLCoordinateBounds bounds, nuint zoomLevel);
    }

    interface IMGLComputedShapeSourceDataSource { }
    ...
    interface MGLComputedShapeSource
    {
        ...
        void SetFeatures(MGLFeature[] features, nuint x, nuint y, nuint zoomLevel);
    ...
    partial interface Constants
    {
        ...
        NSString MGLTileSourceOptionDEMEncoding { get; }
    }
    ...
    //Error CS0708: 'MGLAdditions.Attributes': cannot declare instance members in a static class (CS0708)
    ...
    interface NSValue_MGLAdditions
    {
        ...
        MGLMapPoint MGLMapPointValue { get; }
        ...
        //[Verify(MethodToProperty)]
        MGLCoordinateQuad MGLCoordinateQuadValue { get; }
    ...
    partial interface Constants
    {
        ...
        NSString MGLExpressionInterpolationModeLinear { get; }
        ...
        NSString MGLExpressionInterpolationModeExponential { get; }
        ...
        NSString MGLExpressionInterpolationModeCubicBezier { get; }
    }

    //Error CS0708: 'NSPredicate_MGLAdditions.Attributes': cannot declare instance members in a static class
    ...
    interface NSExpression_MGLAdditions
    {
        ...
        //Error CS0708: 'NSExpression_MGLAdditions.Mgl_jsonExpressionObject': cannot declare instance members in a static class
        ...
        //Error CS0708: 'MGLRasterStyleLayerAdditions.MGLRasterResamplingModeValue': cannot declare instance members in a static class
    ...
    interface NSPredicate_MGLAdditions
    {
        ...
        //Error CS0708: 'NSPredicate_MGLAdditions.Mgl_jsonExpressionObject': cannot declare instance members in a static class
        // @property (readonly, nonatomic) id _Nonnull mgl_jsonExpressionObject;
        [Static]
        [Export("mgl_jsonExpressionObject")]
        NSObject Mgl_jsonExpressionObject { get; }
    ...
    {
        // @optional @property (assign, nonatomic) CLLocationDistance distanceFilter;
        [Export("distanceFilter")]
        double DistanceFilter { get; set; }

        // @optional @property (assign, nonatomic) CLLocationAccuracy desiredAccuracy;
        [Export("desiredAccuracy")]
        double DesiredAccuracy { get; set; }

        // @optional @property (assign, nonatomic) CLActivityType activityType;
        [Export("activityType", ArgumentSemantic.Assign)]
        CLActivityType ActivityType { get; set; }

        //Error CS0500: 'MGLLocationManager.Delegate.get' cannot declare a body because it is marked abstract
        [Wrap("WeakDelegate")]
        [NullAllowed]
    ...
    {
        // @property (copy, nonatomic) MGLLoggingBlockHandler _Null_unspecified handler;
